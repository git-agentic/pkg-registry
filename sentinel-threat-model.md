...
**Distribution note (ADR-0052):** the published `@agentic-sentinel/sandbox` npm package
...
(`node node_modules/@agentic-sentinel/sandbox/scripts/build-native.mjs`); monorepo
