...
**Distribution note (ADR-0052):** the published `@git-agentic/sentinel-sandbox` npm package
...
(`node node_modules/@git-agentic/sentinel-sandbox/scripts/build-native.mjs`); monorepo
