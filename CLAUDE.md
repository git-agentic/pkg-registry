...
npm test                 # engine + end-to-end proxy: 660 tests on this host (658 pass, 2 skipped on darwin).
                         ...
                         # skip as describe-level blocks on darwin ("requires Linux") and are not in the 660
                         ...
                         # Seatbelt effect suite does, and ARE in the 660 count. Phase 25 Slice 1's
