...
npm test                 # engine + end-to-end proxy: 396 tests on this host (394 pass, 2 skipped on darwin).
                         ...
                         # skip as describe-level blocks on darwin ("requires Linux") and are not in the 396
                         ...
                         # Seatbelt effect suite does, and ARE in the 396 count.
