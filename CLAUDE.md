...
npm test                 # engine + end-to-end proxy: 631 tests on this host (629 pass, 2 skipped on darwin).
                         ...
                         # skip as describe-level blocks on darwin ("requires Linux") and are not in the 631
                         ...
                         # Seatbelt effect suite does, and ARE in the 631 count. Phase 25's
