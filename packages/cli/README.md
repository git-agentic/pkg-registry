...
```bash
npm install -g @git-agentic/sentinel-cli@alpha

sentinel --version
sentinel audit is-odd 3.0.1        # requires a running @git-agentic/sentinel-proxy
sentinel audit-tree package-lock.json
```

Most commands talk to a running [`@git-agentic/sentinel-proxy`](https://www.npmjs.com/package/@git-agentic/sentinel-proxy)
